...
```
### Setting Up MySQL
The project uses MySQL. You need to execute the scripts in `src/main/resources/sql/init.sql` to initialize the database.
...
5. In the environment variables setup window, click the `+` button to add new environment variables, such as:
   ...
   - `REDIS_PORT`, `REDIS_PASSWORD`, `ROCKETMQ_PRODUCER_NAME_SERVER`, `ROCKETMQ_CONSUMER_NAME_SERVER`, `MYSQL_URL`, `MYSQL_USERNAME`, `MYSQL_PASSWORD`, `JWT_SECRET` (ensure your `JWT_SECRET` key is at least 512 bits, which can be generated using `openssl rand -base64 64`).
...
```sh
--REDIS_HOST=your-redis-host --REDIS_PORT=6379 --REDIS_PASSWORD=your-password --ROCKETMQ_PRODUCER_NAME_SERVER=your-rocketmq-server --ROCKETMQ_CONSUMER_NAME_SERVER=your-rocketmq-server --MYSQL_URL=your-mysql-url --MYSQL_USERNAME=your-mysql-username --MYSQL_PASSWORD=your-mysql-password --JWT_SECRET=your-jwt-secret
```
...
```bash
mvn spring-boot:run -Dspring-boot.run.arguments="--REDIS_HOST=your-redis-host --REDIS_PORT=6379 --REDIS_PASSWORD=your-password --ROCKETMQ_PRODUCER_NAME_SERVER=your-rocketmq-server --ROCKETMQ_CONSUMER_NAME_SERVER=your-rocketmq-server --MYSQL_URL=your-mysql-url --MYSQL_USERNAME=your-mysql-username --MYSQL_PASSWORD=your-mysql-password --JWT_SECRET=your-jwt-secret"
```
